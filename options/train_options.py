...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--use_fp16', type=bool, default=False, help='Use mixed precision training')
        parser.add_argument('--opt_level', type=str, default='O1', help='Select AMP optimization level')
